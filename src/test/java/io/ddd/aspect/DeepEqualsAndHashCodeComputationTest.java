...
public class DeepEqualsAndHashCodeComputationTest
{
     ...
     */
    public DeepEqualsAndHashCodeComputationTest(final Object equalA, final Object equalB, final Object notEqual, final Class<? extends Throwable> expected)
    {
        this.equalA = equalA;
        this.equalB = equalB;
